...
#    try_ozaria: "Try Ozaria"
  ...
  nav:
    ...
    support: "Підтримка"
    faqs: "Часті Питання"
    copyright_prefix: "Авторське право"
    copyright_suffix: "Всі права захищено."
    help_pref: "Потрібна допомога? Надішліть Email"
    help_suff: "і ми будемо на зв'язку!"
    resource_hub: "Ресурси"
#    apcsp: "AP CS Principles"
    parent: "Батьки"
    browser_recommendation: "Для найкращого вреження ми рекомендуємо використовувати останню версію браузера Google Chrome. Скачайте браузер тут!"
  ...
  play:
    title: "Грай CodeCombat рівні - вивчай Python, JavaScript, та HTML"
    meta_description: "Вивчай програмування разом з іграми кодування для початківців. Вивчай Python або JavaScript під час знаходження шляху в лабіринтах, створюй власні ігри та проходь на вищий рівень!"
    level_title: "__level__ - Вивчай кодування Python, JavaScript, HTML"
    video_title: "__video__ | Відео Рівень"
    game_development_title: "__level__ | Розробка ігор"
    web_development_title: "__level__ | Розробка Web"
    anon_signup_title_1: "CodeCombat має"
    anon_signup_title_2: "Версія для класу!"
    anon_signup_enter_code: "Ввести Код Класу:"
    anon_signup_ask_teacher: "Не має аккаунта? Запитай свого вчителля!"
    anon_signup_create_class: "Хочеш створити клас?"
    anon_signup_setup_class: "Створи клас, долучи своїх студентів та відслідковуй прогрес!"
    anon_signup_create_teacher: "Створи безкоштовний профіль вчителя!"
  ...
  signup:
    ...
    eu_confirmation: "Я погоджують та дозволяю CodeCombat зберігати мої дані на серверах Сполучених Штатів." #"I agree to allow CodeCombat to store my data on US servers."
    eu_confirmation_place_of_processing: "Дізнатися більше про пожливі ризики" #"Learn more about the possible risks"
    eu_confirmation_student: "Якщо Ви не впевнені - запитайте вашого вчителля. " #"If you are not sure, ask your teacher."
    eu_confirmation_individual: "Якщо Ви не хочете щоб ми зберігали Ваші дані на серверах Сполучених Штатів - Ви завжди можете продовжити грати анонімно, без збереження Вашого коду." #"If you do not want us to store your data on US servers, you can always keep playing anonymously without saving your code."
  ...
  common:
    default_title: "CodeCombat - Ігри в кодування для вивчення Python та JavaScript" #"CodeCombat - Coding games to learn Python and JavaScript"
    default_meta_description: "Вивчай як набирати код під час програмування ігор. Вивчай Python, JavaScript та HTML вирішуючи головоломки та вивчай як створити власні ігри та вебсайти." #"Learn typed code through a programming game. Learn Python, JavaScript, and HTML as you solve puzzles and learn to make your own coding games and websites."
    ...
    submit: "Надіслати" #"Submit"
    replay: "Повторити"#"Replay"
